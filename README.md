...
4. chmod +x CloverBuildScripts/buildme && chmod +x CloverBuildScripts/xbuildme
5. cp -f CloverBuildScripts/buildme CloverBootloader && cp -f CloverBuildScripts/xbuildme CloverBootloader
6. cd CloverBootloader
7. ./buildme or ./xbuildme 😉
